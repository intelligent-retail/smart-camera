            ...
            if opt == '-h':
                ...
                if protocol_string == "http":
                    ...
                    if hasattr(IoTHubTransportProvider, "AMQP"):
                        ...
                        raise OptionError(
                            "Error: AMQP protocol is not supported")
                    ...
                    if hasattr(IoTHubTransportProvider, "AMQP_WS"):
                        ...
                        raise OptionError(
                            "Error: AMQP_WS protocol is not supported")
                    ...
                    if hasattr(IoTHubTransportProvider, "MQTT"):
                        ...
                        raise OptionError(
                            "Error: MQTT protocol is not supported")
                    ...
                    if hasattr(IoTHubTransportProvider, "MQTT_WS"):
                        ...
                        raise OptionError(
                            "Error: MQTT_WS protocol is not supported")
                else:
                    raise OptionError(
